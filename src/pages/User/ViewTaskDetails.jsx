          ...
          <div className="grid grid-cols-1 md:grid-cols-4 mt-4">
            <div className="form-card col-span-3">
              ...
              <div className="grid grid-cols-12 gap-3">
                ...
                <div className="col-span-6 md:cool-span-4">
                  <InfoBox
                    label="Due Date"
                    value={
                      task?.dueDate
...
const Attachment = ({ link, index, onClick }) => {
  return (
    <div
      className="flex justify-between bg-gray-50 border border-gray-100 px-3 py-2 rounded-md mb-3 mt-2 cursor-pointer hover:bg-gray-100 transition"
